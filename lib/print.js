...
// Rimuovi il placeholder %s per il tipo di messaggio
me + ' ~' + conn.user.name,
m.messageStubType ? m.messageStubType : 'WAMessageStubType', // Manteniamo il placeholder
filesize,
